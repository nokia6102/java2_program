...
public class ExerciseD8L4B extends JFrame {

	Container myContainer = null;

	public ExerciseD8L4B(String title) {
		...
		myBtn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent ae) {
				...
				JOptionPane myOptPane= new JOptionPane(myText.getText(), JOptionPane.WARNING_MESSAGE);
	...
	public static void main(String s[]) {
		ExerciseD8L4B myApp = new ExerciseD8L4B("Dialog Generator");
	}
}