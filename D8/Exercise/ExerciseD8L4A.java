...
public class ExerciseD8L4A extends JFrame {

	Container myContainer = null;

	public ExerciseD8L4A(String title) {
		...
		myBtn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent ae) {
				...
				JOptionPane myOptPane= new JOptionPane(myText.getText(), JOptionPane.ERROR_MESSAGE);
	...
	public static void main(String s[]) {
		ExerciseD8L4A myApp = new ExerciseD8L4A("Dialog Generator");
	}
}